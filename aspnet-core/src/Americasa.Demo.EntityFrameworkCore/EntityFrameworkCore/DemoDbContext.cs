    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<DealerShip>(b =>
        {
            b.ToTable(DemoConsts.DbTablePrefix + "DealerShips", DemoConsts.DbSchema);
        });

        builder.Entity<House>(b =>
        {
            b.ToTable(DemoConsts.DbTablePrefix + "Houses", DemoConsts.DbSchema);
        });

        builder.Entity<HouseStatus>(b =>
        {
            b.ToTable(DemoConsts.DbTablePrefix + "HouseStatuses", DemoConsts.DbSchema);
        });
