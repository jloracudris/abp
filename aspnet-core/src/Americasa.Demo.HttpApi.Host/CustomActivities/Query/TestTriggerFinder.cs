...
{
    public interface ITestTriggerFinder
    {
    ...
    public class TestTriggerFinder: ITestTriggerFinder
    {
        private const int BatchSize = 250;
        private readonly ITestTriggerStore _triggerStore;
        private readonly IContentSerializer _contentSerializer;
        private readonly IBookmarkHasher _bookmarkHasher;

        public TestTriggerFinder(ITestTriggerStore triggerStore, IContentSerializer contentSerializer, IBookmarkHasher bookmarkHasher)
        {
