...
namespace Americasa.Demo.CustomActivities.Query
{
    public class TestWorkflowLaunchpad: ITestWorkflowLaunchpad
    {
        private readonly IWorkflowInstanceStore _workflowInstanceStore;
        private readonly IWorkflowFactory _workflowFactory;
        private readonly IBookmarkFinder _bookmarkFinder;
        private readonly ITestTriggerFinder _triggerFinder;
        private readonly Elsa.Services.IDistributedLockProvider _distributedLockProvider;
        ...
        public TestWorkflowLaunchpad(
            IWorkflowInstanceStore workflowInstanceStore,
            IWorkflowFactory workflowFactory,
            IBookmarkFinder bookmarkFinder,
            ITestTriggerFinder triggerFinder,
            Elsa.Services.IDistributedLockProvider distributedLockProvider,
        ...
        private async Task<IEnumerable<StartableWorkflowDefinition>> CollectStartableWorkflowsInternalAsync(WorkflowsQuery query, CancellationToken cancellationToken = default)
        {
            ...
            var triggers = filter != null ? (await _triggerFinder.FindTriggersAsync(query.ActivityType, new[] { filter } , query.TenantId, cancellationToken: cancellationToken)).ToList() : new List<TriggerFinderResult>();
